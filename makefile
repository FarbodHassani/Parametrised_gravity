...
COMPILER     := mpic++
INCLUDE      := -I/usr/local/include/gsl  -I /Users/farbod/Packages/Kevolution/LATfield2-master  -I /Users/farbod/Packages/hdf5-1.10.1/hdf5/include    # add the path to LATfield2 and other libraries (if necessary)
